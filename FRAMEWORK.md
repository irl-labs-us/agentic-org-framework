...
**Status:** Draft v0.3 — derived from RoleWise's operating model (`docs/coordination/CORE_ORG.md`, `AGENT_OPERATING_CHARTER.md`, `AGENT_EVALUATION_COVENANT.md`, `MISSION_PACKET_TEMPLATE.md`, `DEBUG_PROTOCOL.md`, `STRATEGY.md`) and hardened against the failure modes documented in `docs/coordination/reviews/2026-08-25-memory-architecture-postmortem-and-beta-portfolio.md`.
