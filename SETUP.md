...
4. **Reference it from future mission packets.** Any Mission Packet (§III.5) whose scope includes UI, visual design, or user-facing copy should point at `FRAMEWORK.md` §III.10 and `docs/design/AI_OUTPUT_DISCIPLINE.md` directly, the same way Section 7 (next) will for the first one.
